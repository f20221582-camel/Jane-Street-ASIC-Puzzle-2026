...
[Reverse-engineering a chip layout back into a circuit]([https://github.com/janestreet/asic-puzzle-2026]), using nothing but Python's standard library and one SAT solver.

...
Reverse-engineering a chip layout back into a circuit, using nothing but Python's standard library and one SAT solver. No KLayout, no Magic, no Calibre.
...
> **Spoiler warning.** The answer is below. Stop reading if you want to solve it yourself.
